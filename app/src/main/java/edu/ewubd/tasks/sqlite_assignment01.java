...
public class sqlite_assignment01 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sqlite_assignment01);
        ...
        cancel.setOnClickListener(v-> cancelchanges());

        addimage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (ContextCompat.checkSelfPermission(sqlite_assignment01.this,
                        Manifest.permission.READ_EXTERNAL_STORAGE)!= PackageManager.PERMISSION_GRANTED)
                {
                    ActivityCompat.requestPermissions(sqlite_assignment01.this
    ...
    public void cancelchanges(){
        ...
        sqlite_assignment01 m = new sqlite_assignment01();
        Intent i = new Intent(sqlite_assignment01.this, contact_list.class);
